...
using MisterS.Services.CouponAPI.Mapper;
using MisterS.Services.CouponAPI.Repository;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "MisterS.Services.CouponAPI", Version = "v1" });
    c.EnableAnnotations();
